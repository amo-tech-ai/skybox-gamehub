    ...
    <section className="py-12 md:py-20 bg-black">
      <div className="container px-4">
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-8 lg:gap-12 items-center">
          ...
          {/* Video Column */}
          <div className="animate-fade-in order-1 lg:order-2 flex items-center justify-center">
            <div className="relative rounded-xl overflow-hidden shadow-2xl bg-gradient-to-br from-secondary/20 to-primary/20 p-1 w-full max-w-[360px] lg:max-w-[400px] max-h-[520px] lg:max-h-[560px]">
              <div className="bg-card rounded-lg overflow-hidden">
                <iframe
                  ...
                  width="640"
                  height="360"
                  style={{ height: "auto", width: "100%", aspectRatio: "9 / 16", objectFit: "contain" }}
