...
### Summary: Two APIs Working Together

**YouTube Data API v3** (for fetching):
- Gets video list from channels like [youtube.com/nfl](https://www.youtube.com/nfl)
- Returns video IDs, titles, thumbnails, metadata
- Requires API key from Google Cloud Console
- Documentation: [developers.google.com/youtube/v3](https://developers.google.com/youtube/v3)

**Vidstack YouTube Provider** (for playing):
- Plays videos using video IDs from the API
- Handles YouTube iframe embedding
- Provides custom player controls
- Documentation: [vidstack.io/docs/player/api/providers/youtube](https://vidstack.io/docs/player/api/providers/youtube)

**Together**: Fetch with YouTube API → Play with Vidstack
