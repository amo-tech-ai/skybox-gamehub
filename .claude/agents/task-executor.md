---
name: task-executor
description: Implements and completes specific Task Master tasks. Focuses on actual code execution, file creation/modification, and testing. Use when task-orchestrator identifies work to do or when user requests specific implementation. Handles task status updates and progress logging.
model: sonnet
color: blue
tools:
  - Read
